          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex justify-between mt-2">
                ...
                <span className="capitalize"> {product.billavailable}</span>
              </div>

              <div className="flex justify-between mt-2">
                <span>Box Available</span>
                <span className="capitalize">{product.boxavailable}</span>
              </div>
              <div className="flex justify-between mt-2">
              ...
              <div className="flex justify-between mt-2">
                ...
                <span className="capitalize">{product.warrantyavailable}</span>
              </div>
              <div className="flex justify-between mt-2">
